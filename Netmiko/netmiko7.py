...
for ip in device_ip:
    ...
    print('Creating thread for the device : ' + ip)
    config_thread_list.append(threading.Thread(target=worker, args(device,)))
...
print('Ending all threads. Elapsed time: ' +  time() - start_time)